 ...
 * <code>disjunction == true</code>. See also the {@link QueryFilter} class.
 ...
 * base search object. With JPA this eagerly loads the specified properties.
 * Otherwise they might be loaded lazily. This is useful for performance and
 * results that will be disconnected from JPA and copied to a remote client.
 ...
 * provides getters for each of the properties. The {@link IMutableQuery}
