...
public class ExampleOptions {
    ...
    /**
     * <p>
     * This is a list of properties to exclude. For example if a person object
     * is as an example and it is not desirable to filter on the person's
     * parents, the mother and father properties can be excluded by setting this
     * list to contain the strings "mother" and "father".
     * 
     * <p>
     * Default: &lt;none&gt;
     */
    ...
    /**
     * <p>
     * If this is true, all properties with <code>null</code> values will be
     * ignored.
     * 
     * <p>
     * Default: true
    ...
    /**
     * <p>
     * If this is true, all properties with the value <code>0</code> will be
     * ignored.
     * 
     * <p>
     * Default: false
    ...
    /**
     * <p>
     * This options describes how all string values are compared. The options
     * are:
     * <ul>
